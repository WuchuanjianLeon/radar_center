...
void TIM2_IRQHandler(void)
{
 ...
 if(IC2flag[4]>25) {Frequency[4]=0;IC2flag[4]=0;IC2Value[4]=0;}
 if(IC2flag[5]>25) {Frequency[5]=0;IC2flag[5]=0;IC2Value[5]=0;}
...
void TIM4_IRQHandler(void)
{
 ...
 if(IC2flag[0]>25) {Frequency[0]=0;IC2flag[0]=0;IC2Value[0]=0;}
 if(IC2flag[1]>25) {Frequency[1]=0;IC2flag[1]=0;IC2Value[1]=0;}
 if(IC2flag[2]>25) {Frequency[2]=0;IC2flag[2]=0;IC2Value[2]=0;}
 if(IC2flag[3]>25) {Frequency[3]=0;IC2flag[3]=0;IC2Value[3]=0;}
